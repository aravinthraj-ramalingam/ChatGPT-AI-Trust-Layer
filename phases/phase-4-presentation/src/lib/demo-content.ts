/** Demo answer with extractable assumptions and risks for judgment layer */
...
export const DEMO_PROMPT_HINT =
  "Try: Should we enter the EU market in 2026 given our regulatory timeline and budget?";
