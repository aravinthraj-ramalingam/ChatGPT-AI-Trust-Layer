...
| 2 — Judgment engines | `phases/phase-2-judgment-engines/` | Planned |
| 3 — Pipeline & answer layer | `phases/phase-3-pipeline/` | Planned |
| 4 — Presentation layer | `phases/phase-4-presentation/` | Planned |
| 5 — Feedback & integration | `phases/phase-5-feedback/` | Planned |
